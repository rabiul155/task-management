...
const Home = () => {
    return (
        <div>
            <section className="bg-gray-100 dark:bg-gray-700 dark:text-gray-100 ">
                <div className="container flex flex-col justify-center p-6 mx-auto sm:py-6 lg:py-8 lg:flex-row lg:justify-between">
                    <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
                        <h1 className="text-5xl font-bold  sm:text-6xl">Complete
                            <span className="text-violet-400"> Your Everyday</span> Task
                        </h1>
                        ...
                        <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
                            <a rel="noopener noreferrer" href="/" className="px-8 py-3 text-lg font-semibold rounded bg-violet-400 text-gray-900">Register Now</a>
