    ...
    return (
        ...
        <div className=' flex justify-center '>
            <div className=' w-96 border-purple-700  p-6'>
                <form onSubmit={handleSubmit} >
                    ...
                    <div className=' flex justify-between pr-2'>
                        <div class="flex items-start mb-6">
                            ...
                            <label for="remember" class="ml-2 text-sm font-medium text-gray-100">Remember me</label>
                        </div>

                        <label class="ml-2 text-sm font-medium text-gray-100">Forgot password?</label>
                    </div>
                ...
                <button onClick={handleGoogle} type="submit" class="text-white bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-900 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center uppercase"> continue with Google</button>
            </div>
